...
# Check new examples
new_ids = ['identity-0075', 'identity-0076', 'identity-0077', 'identity-0078', 'identity-0079']
print()
...
# Check all previous batches are intact
...
batch2_ids = ['identity-0060', 'identity-0061', 'identity-0062', 'identity-0063', 'identity-0064']
print()
print('BATCH 2 ADDITIONS CHECK:')
for id_val in batch2_ids:
    if any(id_val in line for line in lines):
        print(f'  {id_val}: PRESENT')
    else:
        print(f'  {id_val}: MISSING (BAD)')

batch3_ids = ['identity-0065', 'identity-0066', 'identity-0067', 'identity-0068', 'identity-0069']
print()
print('BATCH 3 ADDITIONS CHECK:')
for id_val in batch3_ids:
    if any(id_val in line for line in lines):
        print(f'  {id_val}: PRESENT')
    else:
        print(f'  {id_val}: MISSING (BAD)')

batch4_ids = ['identity-0070', 'identity-0071', 'identity-0072', 'identity-0073', 'identity-0074']
print()
print('BATCH 4 ADDITIONS CHECK:')
for id_val in batch4_ids:
    if any(id_val in line for line in lines):
        print(f'  {id_val}: PRESENT')
    else:
        print(f'  {id_val}: MISSING (BAD)')
